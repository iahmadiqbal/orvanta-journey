                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Centrally located in London's business district with easy access to public transport
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <a href="tel:+442012345678" className="text-secondary font-semibold hover:underline">
                  +44 20 1234 5678
                </a>
              </motion.div>
              ...
              >
                ...
                <a href="mailto:uk@orvanta.com" className="text-secondary font-semibold hover:underline">
                  uk@orvanta.com
                </a>
              </motion.div>
            </div>
